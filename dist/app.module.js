...
const patient_module_1 = require("./infrastructure/ioc/patient.module");
const doctor_module_1 = require("./infrastructure/ioc/doctor.module");
const schedule_1 = require("@nestjs/schedule");
const email_module_1 = require("./infrastructure/ioc/email.module");
let AppModule = (() => {
        ...
        common_1.Module({
            imports: [
                ...
                config_1.ConfigModule.forRoot({
                    ...
                    envFilePath: environments_1.setEnvironment(),
                }),
